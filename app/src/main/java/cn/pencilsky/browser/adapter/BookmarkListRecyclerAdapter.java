 ...
 */
public class BookmarkListRecyclerAdapter extends RecyclerView.Adapter<BookmarkListRecyclerAdapter.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public BookmarkListRecyclerAdapter(Context context, List<Bookmark> data) {
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = inflater.inflate(R.layout.item_bookmark_list, parent, false);
    ...
    public boolean onLongClick(View v) {
        ...
        int childAdapterPosition = mRecyclerView.getChildAdapterPosition(v);
        if (onItemClickListener != null) {
            return onItemClickListener.OnItemLongClick(childAdapterPosition, data.get(childAdapterPosition));
        }
        return false;
    }
    ...
    public interface OnItemClickListener {
        ...
        boolean OnItemLongClick(int position, Bookmark model);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            icon = (ImageView) itemView.findViewById(R.id.bookmarkIcon);
